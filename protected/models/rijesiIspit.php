 ...
 */
class rijesiIspit extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('predmet_idPredmet, objavljen, rijesen', 'numerical', 'integerOnly'=>true),
			array('naziv_ispita', 'length', 'max'=>45),
			array('opis_ispita', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idispit, naziv_ispita, opis_ispita, predmet_idPredmet, objavljen, rijesen', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return rijesiIspit the static model class
	 */
