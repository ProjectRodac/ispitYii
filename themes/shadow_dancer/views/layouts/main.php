...
<?php /*$this->widget('application.extensions.mbmenu.MbMenu',array(
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                            ...
                            array('label'=>'Home', 'url'=>array('/site/index')),
                                array('label'=>'Rijesi ispit', 'url'=>array('/rijesiIspit'), 'visible'=>Yii::app()->user->checkAccess('ucenik')),
                                array('label'=>'Predmet', 'url'=>array('/predmet'), 'visible'=>Yii::app()->user->checkAccess('profesor')),
				array('label'=>'Ispit', 'url'=>array('/ispit/admin'),'visible'=>Yii::app()->user->checkAccess('profesor')),
                            ...
                            //array('label'=>'Predmeti Korisnika', 'url'=>array('/predmetiUsera/create', 'view'=>'about'),'visible'=>Yii::app()->user->checkAccess('ucenik')),
                                array('label'=>'Odgovori', 'url'=>array('/odgovor/admin'), 'visible'=>Yii::app()->user->checkAccess('profesor')),
				array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by E-ispit team<br/>
